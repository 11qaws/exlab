...
export const STREAMER_THEMES = [
  ...
  },
  {
    ...
    light: {
      accent: STREAMER_COLOR_PALETTES.mangjing.main,
      accentOn: "#01040c",
      accentInk: STREAMER_COLOR_PALETTES.mangjing.dark,
      accentBg: "hsl(226 49% 94%)",
      accentLine: STREAMER_COLOR_PALETTES.mangjing.light,
      ...
      railStart: STREAMER_COLOR_PALETTES.mangjing.main,
      railEnd: STREAMER_COLOR_PALETTES.mangjing.dark,
    },
    dark: {
